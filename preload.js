...
contextBridge.exposeInMainWorld('api', {
  ...
  resetSalarioHistorial: () => ipcRenderer.invoke('salarios:reset-base'),
  ...
  reporteNominaDepartamentos: () => ipcRenderer.invoke('reportes:nomina-departamentos'),
  reporteEmpleados: () => ipcRenderer.invoke('reportes:empleados'),
  reporteCedulasVencer: () => ipcRenderer.invoke('reportes:cedulas-vencer'),
  reporteAniversarios: (anio) => ipcRenderer.invoke('reportes:aniversarios', { anio }),
  reporteBeneficios: () => ipcRenderer.invoke('reportes:beneficios'),
  reportePrint: (title, html) => ipcRenderer.invoke('reportes:print', { title, html }),
  reportePdf: (title, html) => ipcRenderer.invoke('reportes:pdf', { title, html }),
  ...
  openMailto: (to, subject, body, cc) => ipcRenderer.invoke('correos:mailto', { to, subject, body, cc }),
